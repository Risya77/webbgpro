...
classifier = load_model(r'C:\Users\asus vivobook\bgproject\pendukung\checkpoint\trained_model.h5')
detector = cv2.CascadeClassifier(r'C:\Users\asus vivobook\bgproject\pendukung\checkpoint\frontalface.xml')
